...
struct BlackjackModel {
    ...
    private(set) var playerBalance: Int = 400  // Starting balance
    ...
    mutating func doubleDown() -> Bool {
        ...
        // Funkcja do tworzenia pełnej talii kart
        ...
        // Funkcja do przetasowania talii
        mutating func shuffleDeck() {
            deck.shuffle()
        }
        
        // Funkcja, która rozdaje dwie karty graczowi i dwie karty dealerowi
    ...
    private mutating func settleBet() {
        ...
        // Funkcja, która dealer dobiera karty, jeśli ma mniej niż 17 punktów
        ...
        // Funkcja do obliczenia punktów dla danej ręki
        ...
        // Funkcja do sprawdzenia, czy gra się skończyła
        private mutating func checkGameOver() {
            ...
            // Regular game ending conditions
            if playerScore > 21 {
                        isGameOver = true
    ...
    struct Card: Identifiable {
        ...
        var numericValue: Int? {
            switch value {
            case "A":
                return 11  // You might want to handle Aces as 1 or 11 later
            case "K", "Q", "J":
                return 10
            default:
                return Int(value)
